...
class InsideHeader extends Component {
  ...
  render() {
    const {locale, navCollapsed, token} = this.props;
              ...
              <ul className="gx-login-list">
                {
                  !token ?
                    <>
                      <Link to="/signin" activeClassName="active"><li>Login</li></Link>
                      <Link to="/signup" activeClassName="active"><li>Signup</li></Link>
                    </> :
...
const mapStateToProps = ({settings, auth}) => {
  ...
  const {token} = auth;
  return {locale, navCollapsed, token}
};
export default connect(mapStateToProps, {toggleCollapsedSideNav, switchLanguage, userSignOut})(InsideHeader);
