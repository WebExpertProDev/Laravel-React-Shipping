              ...
              <Form onSubmit={this.handleSubmit} className="gx-signup-form gx-form-row0">
                ...
                {/* <FormItem>
                  {getFieldDecorator('remember', {
                    ...
                    initialValue: true,
                    rules: [{required: true, message: 'Please check terms!'}]
                  })(
                    <Checkbox onChange={this.onChangeCheckbox}><IntlMessages id="appModule.iAccept"/></Checkbox>
                  )}
...
export default connect(mapStateToProps, {userSignUp, fetchError})(WrappedSignUpForm);
